                ...
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 3H3V5H4.5L7 18C7.15 19 8.1 19.8 9.1 19.8H18.9C19.9 19.8 20.85 19 21 18L23 5H4.5"
                          stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" className="text-black"/>
                    <path d="M9 9V15"
                          stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" className="text-black"/>
                    <path d="M12 9V15"
                          stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" className="text-black"/>
                    <path d="M15 9V15"
                          stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" className="text-black"/>
